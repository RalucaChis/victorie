...
export default {
  ...
  created () {
    // get the available components json after the Vue component is mounted/page loaded
    // this.$store
    //   .dispatch("fetchAvailableComponents")
    //   .then(response => (this.availableUiComponents = response.data))
    //   .catch(error => {
    //     this.notify_error(error);
    //   });
  },
